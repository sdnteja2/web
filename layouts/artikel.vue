  ...
  <div>
    ...
    <UContainer class="py-20 ">
      <div class="max-w-3xl mx-auto">
        <UBreadcrumb
          class="my-4 px-2 py-1 ring-1 ring-gray-200 dark:ring-gray-800 rounded-lg text-lg sticky top-[72px] bg-white dark:bg-gray-900  inset-x-0 text-center z-30"
          divider=">"
          :links="[{ label: 'Home', to: '/' }, { label: 'Artikel', to: '/artikel' }]"
        />
        <UCard class="duration-200 transition-all">
          <template #header>
        ...
        <UCard class="my-4 ring-gray-200 dark:ring-gray-800  flex-1 flex flex-col shadow hover:ring-gray-200 dark:hover:ring-ring-gray-800">
          <div class="prose mx-auto prose-red  dark:prose-invert">
            <slot />
          </div>
        </UCard>
        <div class="sticky bottom-3 inset-x-0 text-center">
          <div class="inline-block relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800  p-2  sm:p-3 bg-white dark:bg-gray-900 ">
      ...
      <!-- Footer
          ...
          Content
          <div class="space-y-5 max-w-2xl mx-auto  md:space-y-8">
            <header>
              <UCard>
                <div class="py-4">
                  <h1
                    v-if="page?.title"
                    class="title text-left font-body"
                  >
                    {{ page.title }}
                  </h1>
                </div>
            ...
            <UCard class="prose mx-auto space-y-3 hover:ring-0  dark:prose-invert">
              <slot />
            </UCard>
