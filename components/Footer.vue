      ...
      <div class="grid grid-cols-2 md:grid-cols-4  gap-6 mb-10">
        ...
        <div>
          <div class="mt-3 grid space-y-3 text-sm">
            <p>
              <a
                class="inline-flex gap-x-2 font-semibold text-gray-900 dark:hover:text-blue-500 hover:text-blue-500 dark:text-gray-100"
                href="http://disdik.majalengkakab.go.id/beranda"
              >DISDIK Majalengka</a>
            </p>
            <p>
              <a
          ...
          <div class="mt-3 grid space-y-3 text-sm">
            ...
            <p>
              <a
                class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="#"
              >Careers</a> <span class="inline text-blue-600 dark:text-blue-500">— We're hiring</span>
            </p>
            <p>
              <a
                class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
          <div class="flex items-center gap-x-3">
            ...
            <div class="hs-dropdown relative inline-flex [--placement:top-left]">
              ...
              >
                <svg
                  id="flag-icon-css-us1" class="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
                  <g fill-rule="evenodd">
                    <g stroke-width="1pt">
              ...
              >
                ...
                >
                  <svg
                    id="flag-icon-css-us" class="flex-shrink-0 w-3.5 h-3.5 rounded-full"
                ...
                >
                  <svg
                    id="flag-icon-css-de" class="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-dk" class="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-it" class="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-cn" class="w-3 h-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="space-x-4">
              <a class="inline-block text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" href="#">
                <svg
                  class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
